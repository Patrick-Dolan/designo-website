  ...
  return (
    <CardTemplate className="h-211 rounded-none text-white overflow-hidden relative bg-home-hero-pattern bg-no-repeat bg-left md:bg-md-home-hero-pos">
      <div className="relative flex flex-col gap-6 pt-20 z-10 md:px-15">
        ...
        <p className="text-center leading-7 text-15px md:text-base md:px-10">With over 10 years in the industry, we are experienced in creating fully responsive websites, app design, and engaging brand experiences. Find out more about our services.</p>
